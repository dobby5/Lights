            ...
            for (int pixel = 0; pixel < dividedLightsArray[light]; pixel++)
            {
              ...
              if (pixel <= pixelOffset) {
                if (light == lightsCount - 1) {
                  strip->SetPixelColor(pixel, convFloat(lights[2].currentColors));
                }
              }
